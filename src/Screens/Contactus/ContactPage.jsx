    ...
    <Layout className="container1" style={{ width: "100%" }}>
      <div>
        ...
        <div className="container " style={{ width: "100%" }}>
          ...
          <button
            type="button"
            class="btn1 inline-flex items-center justify-evenly sm:w-1/2 md:w-72 mt-6 text-white bg-yellow-600 hover:bg-yellow-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2  dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-700 dark:border-yellow-700"
          >
            <MdOutlineMessage></MdOutlineMessage>VIA SUPPORT CHAT
          </button>
          <button
            type="button"
          ...
          <div>
            <button
              type="button"
              class="btn2 inline-flex items-center justify-center  mt-6 text-white bg-yellow-600 hover:bg-yellow-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2  dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-700 dark:border-yellow-700"
            >
              <FiMail></FiMail>VIA EMAIL FORM
            </button>
          </div>

          <div className="formdiv grid md:grid-cols-2 md:gap-6 sm:grid-cols-1 sm:gap-10">
            <form
              className="mb-6 group mt-4 mr-14 "
              style={{ width: "90%", color: "white", fontSize: "12px" }}
