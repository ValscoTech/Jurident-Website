    ...
    >
      <div className="relative grid grid-cols-2 ">
        ...
        <button
          type="button"
          href="#"
          className=" flex relative flex-row sm:w-[200px] lg:w-[400px] hover:border-spacing-4 items-center active:border hover:bg-transparent hover:text-black justify-center sm:gap-1  lg:gap-5 p-4 bg-[#2A4ECA] rounded-full"
        >
          <GoArrowDownRight className=" text-white sm:text-lg lg:text-5xl hover:text-black" />
          <span className="text-white text-sm sm:text-lg lg:text-3xl hover:text-black">
            Download App
          </span>
        </button>
      </div>
