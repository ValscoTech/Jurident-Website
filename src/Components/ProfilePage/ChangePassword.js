  ...
  return (
    <Layout className="xl:mx-[260px] text-black mx-[25px]">
      <div className="flex flex-col justify-center xl:flex-row md:flex-row mt-6">
        <Profile />
        <div className="p-4 xl:w-[650px] ml-5 xl:h-[700px] w-[380px] h-[800px] mr-[15px] xl:mr-[0px] bg-slate-100  dark:bg-transparent mt-[90px] rounded-xl border-2 border-orange-300 ">
          <h1 className="font-bold text-black text-xl mt-[12px] dark:text-white">
          ...
          <form className="mt-[30px] text-black space-y-6">
            <div className="w-full dark:text-[#CFA95E]">
              ...
              <input
                id="currentPassword"
                className="w-full dark:text-[#CFA95E] dark:bg-transparent h-[40px] rounded-xl border-2 border-orange-300 outline-none pl-[10px]"
            ...
            <div className="w-full dark:text-[#CFA95E]">
              ...
              <input
                id="confirmPassword"
                className="w-full dark:text-[#CFA95E] h-[40px] dark:bg-transparent rounded-xl border-2 border-orange-300 outline-none pl-[10px]"
